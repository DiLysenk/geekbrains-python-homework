...
У данного класса должны быть следующие атрибуты: ​speed,​ color, ​​name,​ i​s_police (​булево).
А также методы: ​go, ​​stop, ​t​urn(direction), ​которые должны сообщать, что машина поехала, остановилась, повернула (куда).
